...
export const leaveNoticeAPI = {
    ...
    getLeaveNoticeById: async (noticeId) => {
        const response = await fetch(`${API_BASE_URL}/admin/leave-notices/${noticeId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            }
    ...
    updateNoticeStatus: async (noticeId, statusData) => {
        const response = await fetch(`${API_BASE_URL}/admin/leave-notices/${noticeId}/status`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    updateReviewNotes: async (noticeId, reviewNotes) => {
        const response = await fetch(`${API_BASE_URL}/admin/leave-notices/${noticeId}/review-notes`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    processDepositSettlement: async (noticeId, settlementData) => {
        const response = await fetch(`${API_BASE_URL}/admin/leave-notices/${noticeId}/settlement`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const useLeaveNoticesHandlers = () => {
    ...
    const handleStatusChange = async (noticeId, newFrontendStatus, notes = '') => {
        try {
            setError(null);
    ...
    const loadNotices = async () => {
        try {
            ...
            const transformedData = data.map(notice => ({
                ...
                reason: notice.reasonOfLeave?.toLowerCase().replace(/ /g, '_') || 'other',
