...
const Notices = () => {
  ...
  return (
    <div className="min-h-screen p-6 bg-purple-200">
      <h1 className="text-3xl font-bold text-purple-800 mb-6 text-center">Admin Notice Board</h1>
              ...
              <div>
                <div className="flex justify-between items-start mb-2 flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-600">
                    <span className={`px-2 py-0.5 rounded-full font-semibold text-white ${badgeColor[notice.type]}`}>
                      {notice.type}
                    </span>
                    {notice.unread && (
                      <span className="bg-green-600 text-white px-2 py-0.5 rounded-full font-semibold">New</span>
                    )}
                ...
                <p className="text-gray-800 mb-2">{notice.content || notice.message}</p>
                <div className="flex justify-between items-center text-sm text-gray-500">
                  <span>From: {notice.from}</span>
                  <div className="flex gap-4">
                    {notice.createdBy && <span>Created by: {notice.createdBy}</span>}
                    {notice.updatedBy && notice.updatedBy !== notice.createdBy && (
